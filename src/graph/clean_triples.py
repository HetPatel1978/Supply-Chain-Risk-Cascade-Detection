...
_NOISE: set[str] = {
    ...
    # generic terms surfaced by Intel's filing
    "distributors", "key distributors", "others", "non-us", "public sector",
    "tier 1", "incumbent competitors", "technology development partners",
    "coalition of technology companies", "hyperscale customer", "xpu",
    "5th gen", "black/african",
    # Intel fab locations (geographic, not companies)
...
_CATEGORY_SUFFIXES = {"AIBs", "CMs", "IDMs", "ISVs", "OEMs", "ODMs", "JVs",
                       "CSPs", "SoCs", "GPUs", "CPUs", "DPUs", "ASICs"}
...
def is_valid_entity(name: str) -> bool:
    ...
    _NOT_COMPANIES = {
        ...
        # Intel internal program / initiative names, not companies
        "Open System Foundry", "RAMP-C", "Smart Capital", "IDM 2.0",
        "Scale IDM 2.0", "AI PC Acceleration Program",
        # Real orgs mentioned in passing (investors, labs, consortia) — not
        # supply-chain relationships worth keeping given the noisy rule-based
        # extraction that produced them (e.g. "Intel supplier_of MLCommons")
        "Argonne National Laboratory", "Bain Capital", "IMS Nanofabrication",
        "MLCommons", "McAfee", "SolarWinds Corporation", "Stability AI",
        # Product / stock-class name fragments, not companies
        "Mobileye Class", "Mobileye SuperVision", "SuperVision",
    }
